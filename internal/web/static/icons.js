...
// Usage in templates: <svg class="icon"><use href="#icon-dashboard"></use></svg>
// This script defines all <symbol>s in a hidden SVG injected at body start.
// Icons: Lucide (https://lucide.dev), ISC license. stroke-width 1.75, round caps.
(function () {
  var icons = {
    ...
    'store': '<path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7"/><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><path d="M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"/><path d="M2 7h20"/><path d="M22 7v3a2 2 0 0 1-2 2 2.7 2.7 0 0 1-1.59-.63A2 2 0 0 0 18 12a2 2 0 0 1-2-2 2 2 0 0 1-2 2 2 2 0 0 1-2-2 2 2 0 0 1-2 2 2 2 0 0 1-2-2"/>',
  ...
  function build() {
    ...
    for (var name in icons) {
      svg +=
        '<symbol id="icon-' + name + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">' +
        icons[name] +
        '</symbol>';
    }
    svg += '</svg>';
